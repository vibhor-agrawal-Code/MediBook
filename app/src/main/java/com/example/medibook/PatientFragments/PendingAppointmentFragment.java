package com.example.medibook.PatientFragments;
...
import com.example.medibook.Adapters.PendingAppointmentAdapter;
import com.example.medibook.DataRetrievalClass.PatientAppointmentRequest;
...
public class PendingAppointmentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        FirebaseDatabase.getInstance().getReference().child("PendingPatientAppointments").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter=new PendingAppointmentAdapter(getActivity().getApplicationContext(), appointmentRequestList);
