package com.example.medibook.DoctorFragments;
...
import com.example.medibook.Adapters.AppointmentRequestAdapter;
import com.example.medibook.DataRetrievalClass.AppointmentRequest;
import com.example.medibook.R;
import com.example.medibook.ReusableFunctionsAndObjects;
...
public class AppointmentRequestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        FirebaseDatabase.getInstance().getReference().child("PendingDocAppointments").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                appointmentRequestAdapter=new AppointmentRequestAdapter(getActivity().getApplicationContext(), appointmentRequestList);
