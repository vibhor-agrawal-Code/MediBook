...
public class DoctorRegister extends AppCompatActivity {
    ...
    private TextInputLayout FirstNameTB,LastNameTB,MobileNoTB,EmailTB,PassTB,ConfirmPassTB,Specilization,City,Address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirstNameTB=findViewById(R.id.drFirstNameTB);
        LastNameTB=findViewById(R.id.drLastNameTB);
        MobileNoTB=findViewById(R.id.drPhoneTB);
        EmailTB=findViewById(R.id.drEmailTB);
        PassTB=findViewById(R.id.drPassTB);
        ConfirmPassTB=findViewById(R.id.drConfirmPassTB);
        Address=findViewById(R.id.drAddress);
        City=findViewById(R.id.drCity);
        Specilization=findViewById(R.id.drSpecilization);
                            ...
                            if (task.isSuccessful()) {
                                FirebaseAuth.getInstance().getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        hashMap.put("Address",Address.getEditText().getText().toString().trim());
                                        hashMap.put("City",City.getEditText().getText().toString().trim());
                                        hashMap.put("Specialization",Specilization.getEditText().getText().toString().trim());
                                        ...
                                        FirebaseDatabase.getInstance().getReference().child("UserDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                ReusableFunctionsAndObjects.showMessageAlert(DoctorRegister.this, "Partially Completed", "To complete the registration click the verification link sent to you email ("+email+").","OK", (byte) 1);
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                ReusableFunctionsAndObjects.showMessageAlert(DoctorRegister.this, "Network Error", "Could'nt register, Please make sure you are connected with internet","OK", (byte) 0);
                                            }
                                        });


                                        FirebaseDatabase.getInstance().getReference().child("DoctorDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                progressDialog.dismiss();
                                                ReusableFunctionsAndObjects.showMessageAlert(DoctorRegister.this, "Partially Completed", "To complete the registration click the verification link sent to you email ("+email+").","OK", (byte) 1);
  ...
  /*  @Override
    public void onBackPressed() {
        startActivity(new Intent(DoctorRegister.this,AskDoctorPatient.class));
